...
<aside
	...
	<div class="h-screen bg-whiteTealinux w-[60vw] flex p-8 pr-4 transition-transform duration-700 ease-in-out overflow-y-auto"
		class:translate-x-0={itActive}
		class:-translate-x-full={!itActive}>
        ...
        <div class=" w-[95%] px-2">
			...
			<div class="w-[5%] grid justify-end items-center cursor-pointer" on:click={handleClickDButton}>
