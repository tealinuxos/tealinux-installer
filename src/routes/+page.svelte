...
<main class="p-8">
	<div class="bg-[#D9D9D9] w-full grid-rows-1 grid place-items-center py-3 h-[40vh]">
		<h1>Ini banner</h1>
	...
	<div class="w-full mt-8 py-4 flex justify-center md:justify-between flex-wrap gap-y-8 max-h-96 overflow-y-auto">
		{#each [1,2,3,4,5,6] as e}			
			<div class="w-[355px] aspect-square bg-[#D9D9D9]"></div>
		{/each}
	</div>
