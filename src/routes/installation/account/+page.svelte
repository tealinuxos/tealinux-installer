<script>
    ...
    let fullname, username, hostname, password;
...
<section class="flex flex-col items-center justify-center h-screen">
    <form class="flex flex-col">
        ...
        <div class="max-w-md mx-auto mb-4">
            ...
            <div class="relative flex items-center w-[451px] h-[45px] rounded-lg bg-white overflow-hidden border border-greyBorder">
                <input class="peer h-full w-full outline-none text-sm text-gray-700 pr-2 pl-[12px]" type="text" bind:value={fullname} placeholder="Fullname" />
            </div>
        </div>
        ...
        <div class="max-w-md mx-auto mb-4">
            ...
            <div class="relative flex items-center w-[451px] h-[45px] rounded-lg bg-white overflow-hidden border border-greyBorder">
                <input class="peer h-full w-full outline-none text-[14px] text-gray-700 pr-2 pl-[12px]" type="text" bind:value={username} placeholder="Username" />
            </div>
        </div>
        ...
        <div class="max-w-md mx-auto mb-4">
            ...
            <div class="relative flex items-center w-[451px] h-[45px] rounded-lg bg-white overflow-hidden border border-greyBorder">
                <input class="peer h-full w-full outline-none text-[14px] text-gray-700 pr-2 pl-[12px]" type="text" bind:value={hostname} placeholder="Hostname" />
                <svg class="mr-[16px]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="max-w-md mx-auto mb-4">
            ...
            <div class="relative flex items-center w-[451px] h-[45px] rounded-lg bg-white overflow-hidden border border-greyBorder">
                <input class="peer h-full w-full outline-none text-[14px] text-gray-700 pr-2 pl-[12px]" type="password" bind:value={password} placeholder="Password" />
                <svg class="mr-[16px]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_461_173" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                    <path d="M24 0H0V24H24V0Z" fill="white"/>
                    </mask>
        ...
        <div class="mt-[15px] flex items-center">
            ...
            <h3 class="ml-[10px] text-[16px] text-userCheckBox">Make this user administrator(blom selesai)</h3><!-- font not included -->
        </div>
        <div class="max-w-md mx-auto mt-30 mt-[68px]">
            <div class="grid grid-cols-2 gap-[295px]">
                <a href="/installation/locale" class="text-white bg-greyButton hover:bg-gray-500 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 h-[44px] w-[76px]">Back</a>
                <a href="/installation/partition" on:click={handleSetAccount} class="text-white bg-greyButton hover:bg-gray-500 focus:ring-4 focus:ring-gray-900 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none h-[44px] w-[76px]">Next</a>
            </div>
        </div>
