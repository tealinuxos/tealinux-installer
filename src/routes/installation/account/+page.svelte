    ...
    <form class="flex flex-col h-[85dvh] space-y-4">
			...
			<div class="flex items-center gap-3">
				...
				<div class="relative flex-1 h-[45px] rounded-[9.489px] overflow-hidden border border-[#4CDA95] bg-[rgba(30,47,39,0.31)]">
					...
					{:else}
						...
						/>
					{/if}
					<button type="button" class="absolute right-3 top-1/2 -translate-y-1/2 group" on:click={togglePasswordVisibility}>
						<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="transition-all duration-300 group-hover:scale-110">
							{#if passwordVisible}
								<!-- Visible eye icon -->
								<path d="M12 5C5.636 5 1 12 1 12C1 12 5.636 19 12 19C18.364 19 23 12 23 12C23 12 18.364 5 12 5Z" stroke="#4CDA95" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
								<path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="#4CDA95" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
							{:else}
			...
			<div class="flex items-center gap-3">
				...
				<div class="relative flex-1 h-[45px] rounded-[9.489px] overflow-hidden border border-[#4CDA95] bg-[rgba(30,47,39,0.31)]">
					...
					{:else}
						...
						/>
					{/if}
					<button type="button" class="absolute right-3 top-1/2 -translate-y-1/2 group" on:click={togglePasswordConfirmVisibility}>
						<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="transition-all duration-300 group-hover:scale-110">
							{#if passwordConfirmVisible}
								<!-- Visible eye icon -->
								<path d="M12 5C5.636 5 1 12 1 12C1 12 5.636 19 12 19C18.364 19 23 12 23 12C23 12 18.364 5 12 5Z" stroke="#4CDA95" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
		...
		<div class="max-w-md mx-auto mt-4 gap-x-2 flex items-center">
			<div class="relative w-9 h-9">
				...
				/>
				<svg xmlns="http://www.w3.org/2000/svg" class="w-9 h-9 transition-transform duration-300" viewBox="0 0 48 48">
					<circle 
						cx="24" 
						cy="24" 
						r="22" 
