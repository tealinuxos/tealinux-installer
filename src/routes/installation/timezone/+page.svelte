    ...
    {#if showTimezone}
        <form class="text-center w-[50dvw] p-8 rounded-md min-h-[50dvh]">
            ...
            <div class="max-w-md mx-auto mt-8">
                ...
                <div class="relative flex items-center w-[451px] h-[66px] rounded-lg bg-white overflow-hidden border border-greyBorder">
					<svg class="ml-[12px]" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="max-w-md mx-auto mt-[197px]">
                <div class="grid grid-cols-2 gap-[295px]">
                    <a href="/installation/keyboard" class="text-white bg-greyButton hover:bg-gray-500 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 h-[44px] w-[76px]">Back</a>
                    <a href="/installation/locale" on:click={handleSetTimezone} class="text-white bg-greyButton hover:bg-gray-500 focus:ring-4 focus:ring-gray-900 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none h-[44px] w-[76px]">Next</a>
                </div>
            </div>
        </form>
    {/if}
