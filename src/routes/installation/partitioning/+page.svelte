<script>
	...
	onMount(async () => {
		...
		// 		selectedMethod = blueprint.tool || 'single_boot';
...
<TwoSide>
	...
	{#snippet right()}
		...
		<div
			class="flex flex-col h-[600px] p-4 space-y-[15px] mb-[15px] bg-[]  border-[0.5px] border-gray-900 rounded-[10px] font-jakarta"
		>
