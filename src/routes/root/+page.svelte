...
<form action="/" on:submit|preventDefault={handleSubmit} class="mt-8 max-w-md mx-auto">
  <div class="relative z-0 w-full mb-5 group">
      ...
      <input type="password" bind:value={password} class="block py-2.5 px-0 w-full text-xl text-gray-900 bg-transparent border-0 border-b-2 border-black appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " autofocus />
